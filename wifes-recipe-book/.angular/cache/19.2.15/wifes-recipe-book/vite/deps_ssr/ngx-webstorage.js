...
var SyncStorage = class {
  ...
  observe(key) {
    ...
    return this.strategy.keyChanges.pipe((0, import_operators.filter)((changed) => changed === null || changed === key), (0, import_operators.switchMap)(() => this.strategy.get(key)), (0, import_operators.distinctUntilChanged)(), (0, import_operators.shareReplay)({
      refCount: true,
      bufferSize: 1
    }));
  }
...
var BaseSyncStorageStrategy = class {
  ...
  get(key) {
    ...
    if (data !== void 0) return (0, import_rxjs.of)(data);
    try {
