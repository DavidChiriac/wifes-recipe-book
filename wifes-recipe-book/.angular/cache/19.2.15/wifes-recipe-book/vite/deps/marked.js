...
function h(a3, e = "") {
  let t = typeof a3 == "string" ? a3 : a3.source, n = {
    replace: (s, i) => {
...
var m = {
  ...
  fencesBeginRegex: (a3) => new RegExp(`^ {0,${Math.min(3, a3 - 1)}}(?:\`\`\`|~~~)`),
  headingBeginRegex: (a3) => new RegExp(`^ {0,${Math.min(3, a3 - 1)}}#`),
  htmlBeginRegex: (a3) => new RegExp(`^ {0,${Math.min(3, a3 - 1)}}<(?:[a-z].*>|!--)`, "i")
};
var xe = /^(?:[ \t]*(?:\n|$))+/;
var be = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/;
var Te = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/;
...
var ze = __spreadProps(__spreadValues({}, K), {
  lheading: ye,
  table: se,
...
var Me = __spreadProps(__spreadValues({}, K), {
...
var N = __spreadProps(__spreadValues({}, W), {
...
var Xe = __spreadProps(__spreadValues({}, N), {
...
var b = class a {
  ...
  inlineQueue;
  constructor(e) {
    this.tokens = [], this.tokens.links = /* @__PURE__ */ Object.create(null), this.options = e || w, this.options.tokenizer = this.options.tokenizer || new S(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
      inLink: false,
      inRawBlock: false,
      top: true
    };
...
var B = class {
  ...
  parseMarkdown(e) {
    return (n, s) => {
      let i = __spreadValues({}, s), r = __spreadValues(__spreadValues({}, this.defaults), i), o = this.onError(!!r.silent, !!r.async);
