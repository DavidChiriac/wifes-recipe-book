...
export interface ApiTodayRecommendedTodayRecommended
  extends Struct.SingleTypeSchema {
  collectionName: 'today_recommendeds';
  info: {
    displayName: 'Today Recommended';
    pluralName: 'today-recommendeds';
    singularName: 'today-recommended';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::today-recommended.today-recommended'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    favourites: Schema.Attribute.Relation<'manyToMany', 'api::recipe.recipe'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
